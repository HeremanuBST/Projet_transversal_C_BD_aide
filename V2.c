...
void retourner_livre(Bibliotheque* bib) {
    ...
    for (int i = 0; i < bib->nb_emprunts; i++) {
        if (bib->emprunts[i].actif &&
            ...
            if (jours_retard > 0) {
                printf("⚠ RETARD: %d jours\n", jours_retard);
                printf("(Fonctionnalité pénalités à implémenter)\n");
            } else {
...
void afficher_menu_principal() {
    printf("\n");
    printf("╔════════════════════════════════════════╗\n");
    printf("║   BIBLIOTHÈQUE NUMÉRIQUE - MENU       ║\n");
    printf("╚════════════════════════════════════════╝\n");
...
int main() {
    ...
    printf("║  Projet C & Base de Données 2025/26   ║\n");
    printf("╚════════════════════════════════════════╝\n\n");
